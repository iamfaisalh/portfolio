...
export default function Navigation() {
  ...
  return (
    <nav className="shadow-2xl">
        ...
        <div className="flex min-h-16 items-center justify-between">
          ...
          <div className="-mr-2 flex md:hidden">
            <svg
              ...
              width={"40"}
              className={classNames(
                "relative inline-block hamburger-menu hamburger-menu-rotate rounded-md text-gray-400 hover:text-white",
                { "hamburger-menu-active": isOpen }
              )}
              viewBox="0 0 100 100"
            >
              <path
                className="hamburger-menu-line hamburger-menu-top"
                d="m 30,33 h 40 c 0,0 9.044436,-0.654587 9.044436,-8.508902 0,-7.854315 -8.024349,-11.958003 -14.89975,-10.85914 -6.875401,1.098863 -13.637059,4.171617 -13.637059,16.368042 v 40"
              />
              <path
                className="hamburger-menu-line hamburger-menu-middle"
                d="m 30,50 h 40"
              />
              <path
                className="hamburger-menu-line hamburger-menu-bottom"
      ...
      <div
        className={classNames("md:hidden", { hidden: !isOpen })}
        id="mobile-menu"
      >
