        ...
        <div className={cn}>
            {project.is_coming_soon ?
                <div className="absolute left-0 top-0 h-16 w-16">
                    <div className="absolute left-[-36px] top-[32px] w-[170px] transform -rotate-45 bg-brand-pink text-center font-semibold py-1">Coming Soon</div>
                </div>
                :
                null
            }
            {project.live_url ?
                <a href={project.live_url} rel="noreferrer" target="_blank" >
                    <img className="rounded-t-lg w-full h-56 object-cover" src={project.src} alt="Project Preview" />
                </a>
                :
                <img className="rounded-t-lg w-full h-56 object-cover" src={project.src} alt="Project Preview" />
            }
            <div className="p-5">
                {project.live_url ?
                    <a href={project.live_url} rel="noreferrer" target="_blank">
                        <h5 className="mb-2 text-xl font-bold tracking-tight">{project.title}</h5>
                    </a>
                    :
                ...
                <div className="flex items-center">
                    {project.github_url ?
                        <a href={project.github_url} rel="noreferrer" target="_blank" className="inline-flex items-center px-3 py-2 text-sm font-medium text-center bg-brand-pink rounded-lg hover:bg-opacity-90 hover:bg-brand-pink focus:ring-4 focus:outline-none focus:ring-brand-pink">
                            View Code
                    ...
                    {project.live_url ?
                        <a href={project.live_url} rel="noreferrer" target="_blank" className="inline-flex items-center border-b-2 border-transparent hover:border-b-white text-sm font-medium text-center ml-auto">
                            Live Demo
                            <svg className="rtl:rotate-180 w-3.5 h-3.5 ms-2" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 10">
                                <path stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M1 5h12m0 0L9 1m4 4L9 9" />
                            </svg>
...
const PROJECTS: Array<ProjectProps> = [
    {
        ...
        src: PRJ_Uno,
        title: "UNO",
        description: "Web application for the card game, UNO. Some features include accounts, game lobbies, game chat, and leaderboards. TODO: Mobile responsive.",
    ...
    },
    {
        ...
        description: "Web application for an immersive 3D experience in a world of endless adventure. A peaceful world to enjoy where nothing else matters.",
    ...
    },
    {
        ...
        src: PRJ_Shop,
        title: "Shop",
        description: "Web application for E-Commerce. Vendors can list products for sale. Customers can add items to their cart and complete a checkout session.",
    ...
    },
    {
        ...
        src: PRJ_Portfolio,
        title: "My Portfolio",
        description: "This current web application which I built to showcase my skills, experience, education, and projects.",
    ...
    },
    {
        ...
        title: "Concentration",
        description: "iOS application for the card game, Concentration, also known as the matching game.",
        skills: "Swift",
        github_url: "https://github.com/iamfaisalh/concentration",
        live_url: ""
    },
...
export default function Projects() {
    ...
    return (
        <div style={{ minHeight: "calc(100vh - 90px)" }} className="px-6 py-6 flex flex-wrap items-start justify-evenly gap-8">
            {PROJECTS.map((p, i) => <Project key={p.key} project={p} />)}
        </div>
    );
}
